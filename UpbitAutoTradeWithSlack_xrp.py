...
# 시작 메세지 슬랙 전송
post_message(myToken,"#upbit-auto", "autotrade start")
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=10):
            ...
            if target_price < current_price and ma15 < current_price:
                ...
                if krw > 5000:
                    ...
                    post_message(myToken,"#upbit-auto", "XRP buy : " +str(buy_result))
        else:
            xrp = get_balance("XRP")
            if xrp > 10:
                sell_result = upbit.sell_market_order("KRW-XRP", xrp*0.9995)
                post_message(myToken,"#upbit-auto", "XRP buy : " +str(sell_result))
        time.sleep(1)
    except Exception as e:
        print(e)
        post_message(myToken,"#upbit-auto", e)
        time.sleep(1)